# PYTHON-WORKSHOP
Based on your screenshots, Day 1 of the Python workshop covered the **fundamentals of Python programming**. Here are organized notes you can use for revision before Day 2.
